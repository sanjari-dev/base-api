...
sans.endpoint.get(router, get_id, "get_id", "/:account_id");
sans.endpoint.put(router, put_id, "put_id", "/:account_id");
sans.endpoint.delete(router, del_id, "delete", "/:account_id");
